"""Regressão v1.6.28: interpretação natural, associação descrição/quantidade/preço e cliente."""
import ast
import re
...
CASES=[
    ...
    # Casos reais que motivaram a v1.6.28
...
# Autocorreção: a v1.6.28 não deve reintroduzir o item cancelado.
